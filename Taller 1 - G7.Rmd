...
formula_3 = formula(log(y_salary_m) ~ female + age + I(age^2) + factor(maxEducLevel) + informal + estrato1)
...
evaluate_model = function(model) {
  ...
  result = list("RMSE" = RMSE(test$y_salary_m, exp(prediction)),
...
loocv_model = function(i, data, model_formula) {
  ...
  modelo = lm(model_formula, data = train_data)  # Ajustar modelo
