...
lM1 <- lm(impa_oi ~ formal + maxEducLevel, data = db2)
summary(lM1)
...
lM2 <- lm(impa_oi ~ formal + maxEducLevel, data = db2)
summary(lM2)
db2$impa_oi_P <- predict(lM1, newdata = db2)
db2$impa_oi <- ifelse(is.na(db2$impa_oi), db2$impa_oi_P,db2$impa_oi)
