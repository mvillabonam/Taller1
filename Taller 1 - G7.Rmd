...
rm(db_miss,question, M,Nobs,mode_edu,dummy_maxEducLevel,Occupied_description,imp_vars,obs_vars,titles,Stats,Obs_vs_Imp, imp_idx,obs_idx,cols, check,lM2,lM1,N,WAGES,TOTAL_INCOME,RES,LEV)
```
